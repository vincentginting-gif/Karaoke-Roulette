...
export const translations: Record<string, Entry> = {
  ...
  'welcome.offline': { de: 'Ohne Spotify spielen', en: 'Play without Spotify', ko: 'Spotify 없이 플레이' },
  'welcome.offlineHint': {
    de: 'Kein Konto? Wähle eine fertige Karaoke-Playlist oder tippe eigene Songs ein – und leg los.',
    en: 'No account? Pick a ready-made karaoke playlist or type your own songs – and go.',
    ko: '계정이 없나요? 준비된 카라오케 플레이리스트를 고르거나 직접 노래를 입력하고 시작하세요.',
  },
  'picker.offline.title': { de: 'Ohne Spotify', en: 'Without Spotify', ko: 'Spotify 없이' },
  'picker.offline.hint': {
    de: 'Fertige Karaoke-Playlists oder eigene Songs – ohne Login',
    en: 'Ready-made karaoke playlists or your own songs – no login',
    ko: '준비된 카라오케 플레이리스트 또는 직접 입력 – 로그인 없이',
  },
  ...
  'offline.preset.top100': { de: 'Top 100 International', en: 'Top 100 International', ko: '인기 100 인터내셔널' },
  'offline.preset.de': { de: 'Deutsche Hits', en: 'German Hits', ko: '독일 히트' },
  'offline.preset.kpop': { de: 'K-Pop', en: 'K-Pop', ko: 'K-팝' },
  ...
  'offline.sectionMine': { de: 'Meine Playlists', en: 'My playlists', ko: '내 플레이리스트' },
  'offline.newList': { de: 'Neue Playlist', en: 'New playlist', ko: '새 플레이리스트' },
  'offline.createTitle': { de: 'Playlist erstellen', en: 'Create playlist', ko: '플레이리스트 만들기' },
  'offline.editTitle': { de: 'Playlist bearbeiten', en: 'Edit playlist', ko: '플레이리스트 편집' },
  'offline.createBtn': { de: 'Playlist erstellen', en: 'Create playlist', ko: '플레이리스트 만들기' },
  ...
  'party.linkCopied': {
    de: '🔗 Einladungs-Link kopiert – an die Party-Gäste schicken.',
    en: '🔗 Invite link copied – send it to your party guests.',
    ko: '🔗 초대 링크 복사됨 – 파티 참가자에게 보내세요.',
  },
  'party.turn': { de: 'Jetzt dran', en: 'Now up', ko: '지금 차례' },
  'party.needNames': { de: 'Trag Namen ein, dann geht’s los.', en: 'Add some names to get started.', ko: '이름을 입력하면 시작할 수 있어요.' },
  'party.spin': { de: 'Spin!', en: 'Spin!', ko: '돌리기!' },
  'party.waitTurn': { de: '{name} ist dran …', en: '{name} is up …', ko: '{name} 차례 …' },
  'party.waitTurnHint': { de: 'Warte, bis du dran bist.', en: 'Wait for your turn.', ko: '차례를 기다리세요.' },
  'party.players': { de: 'Mitspieler', en: 'Players', ko: '참가자' },
  'party.addName': { de: 'Name hinzufügen', en: 'Add name', ko: '이름 추가' },
  'party.namePlaceholder': { de: 'Name eintippen …', en: 'Type a name …', ko: '이름 입력 …' },
  'party.addHint': {
    de: 'Kein eigenes Handy? Einfach hier mehrere Namen eintragen.',
    en: 'No phone of their own? Just add several names here.',
    ko: '휴대폰이 없나요? 여기에 여러 이름을 입력하세요.',
  },
  'party.remove': { de: 'Entfernen', en: 'Remove', ko: '삭제' },
  'party.songs': { de: 'Songs', en: 'Songs', ko: '노래' },
  'party.addSong': { de: 'Song hinzufügen', en: 'Add song', ko: '노래 추가' },
  'party.songPlaceholder': { de: 'Titel – Interpret …', en: 'Title – Artist …', ko: '제목 – 아티스트 …' },
  'party.nextTurn': { de: 'Als Nächstes singt', en: 'Up next', ko: '다음 차례' },
  'party.again': { de: 'Nochmal', en: 'Again', ko: '다시' },
  'party.order': { de: 'Reihenfolge', en: 'Order', ko: '순서' },
  'party.orderManual': { de: 'Der Reihe nach', en: 'In order', ko: '순서대로' },
  'party.orderRandom': { de: 'Zufällig', en: 'Random', ko: '무작위' },
  'party.noRepeat': { de: 'Schon gesungene Lieder sperren', en: 'Lock already-sung songs', ko: '이미 부른 곡 잠그기' },
  'party.leave': { de: 'Party verlassen', en: 'Leave party', ko: '파티 나가기' },
  'party.joinTitle': { de: 'Party beitreten', en: 'Join a party', ko: '파티 참가' },
  ...
  'party.err.create': { de: 'Party konnte nicht gestartet werden.', en: 'Could not start the party.', ko: '파티를 시작할 수 없습니다.' },
  'party.err.join': { de: 'Beitreten fehlgeschlagen.', en: 'Could not join.', ko: '참가하지 못했습니다.' },
  'party.err.notFound': { de: 'Kein Raum mit diesem Code gefunden.', en: 'No room found with that code.', ko: '해당 코드의 방을 찾을 수 없습니다.' },
  'party.err.gone': { de: 'Die Party ist beendet.', en: 'The party has ended.', ko: '파티가 종료되었습니다.' },
